...
class CliInstall extends \Opencart\System\Engine\Controller {
	...
	public function install(array $argv): string {
		...
		if (!is_file(DIR_OPENCART . 'config.php')) {
			$error .= 'ERROR: config.php does not exist. You need to rename config.php to config.php!' . "\n";
			...
			$error .= 'ERROR: admin/config.php does not exist. You need to rename admin/config.php to admin/config.php!' . "\n";
